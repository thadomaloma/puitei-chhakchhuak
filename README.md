...
Development seeds contain synthetic demonstration records only. Supply `SEED_PASSWORD` explicitly when seeding; no account password is embedded in the repository. Production sample seeding is disabled.
